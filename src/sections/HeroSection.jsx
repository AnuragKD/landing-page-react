          ...
          >
            <div className="relative xl:mx-5 w-full select-none overflow-visible">
              ...
              <div className="absolute inset-0 z-25 pointer-events-none">
                ...
                <div className="absolute top-[10%] left-[46%] w-[3%] h-[2%] bg-[#E88F01]/4 backdrop-blur-[100px] rounded-tr-[100%] [corner-shape:superellipse] [-webkit-corner-shape:superellipse]"></div>
              </div>
            </div>
          </div>
        </div>
